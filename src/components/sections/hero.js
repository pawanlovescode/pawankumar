...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Pawan Kumar.</h2>;
  const three = <h3 className="big-heading">I build things based on full stack deep learning.</h3>;
  const four = (
    <p>
  ...
  const five = (
    <a href={`mailto:heypawansoni@gmail.com`} className="email-link">
      Get In Touch
    </a>
  );
